          ...
          if(isset($_SESSION['id'])){
            if ($donneehbis['etat']=='1') {
              ...
              if ($user['pseudo']==$donneehbis['pseudo_id']) {
                ?>
                <div class=<?php echo $donneeh['nomsalle']; ?> ><div class="accessalle"><a class="accessalle"  href= <?php echo "index.php?action=goto_salleN&c={$donneeh['nomsalle']}"; ?> >
                  <?php echo $name_unstick; ?> <br> <?php echo $donneehbis['nbplaces']; ?> places<br>
                  Modifier réservation <br> </a></div></div>

                  <?php
                }
                  else if($user['isadmin']==1){ //peux acceder a la salle réervée par qq1 d'autre si admin
                    ?>
                    <div class=<?php echo $donneeh['nomsalle']; ?>><a class="accessalle"  href= <?php echo "index.php?action=goto_salleN&c={$donneeh['nomsalle']}"; ?> ><?php echo $name_unstick; ?> <br><?php echo $donneehbis['nbplaces']; ?> places<br> Réservé par <?php echo $donneehbis['pseudo_id']; ?> 
                  <br></a></div>
                  <?php

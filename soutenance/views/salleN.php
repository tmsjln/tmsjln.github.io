...
if(isset($_SESSION['id'])) {
 ...
 $user = $requser->fetch();
 $reqinfocapteurs = $bdd->query("SELECT * FROM controlvalues WHERE nomsalle_id ='".$namesa."'");
 $infocapteurs = $reqinfocapteurs->fetch();
...
<body>
  ...
  <section>
        ...
        <li> <strong>Température</strong> <br>
          Valeur par défaut : 20 degrés. Vous pouvez renseigner n'importe quelle température entre 17 et 25 degrés.
            ...
            <p>
              ...
              <p><I><?php echo "valeur actuelle : ".$infocapteurs['temp'];?></I></p>
          ...
          <li> <strong>Luminosité</strong> <br>
            ...
            <p><form method="post">
              ...
              <p><I><?php echo "valeur actuelle : ".$infocapteurs['lum'];?></I></p>
          ...
          <li> <strong>Ecran de projection</strong><br>
            ...
            <p><form method="post">
              ...
              <p><I><?php echo "valeur actuelle : ".$infocapteurs['screen'];?></I></p>
    ...
    header('Location: profil.php?id='.$_SESSION['id']);
      ...
      if($user['isadmin']==1){
        ...
        if(isset($_POST['delcapt'])){
          ...
          echo "capteur(s) suprimé(s) veuillez rafraichir la page";
    ...
    //echo "ok";
      ...
      echo "salle suprimée, veuillez changer de page";

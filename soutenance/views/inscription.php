            ...
            if($mail == $mail2) {
               ...
               if(filter_var($mail, FILTER_VALIDATE_EMAIL)) {
                  ...
                  if($mailexist == 0) {
                     ...
                     if(strlen($_POST['mdp'])>=8){//longeur mdp mini 
                        if(preg_match('#(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])#',$_POST['mdp'])){
                        // conformité mdp (lettres,maj,chiffre)
                     ...
                     if($mdp == $mdp2) {
                        ...
                        $erreur15 =""; //mdp non conforme 

                     } 
                  }else{
                        $erreur14 ="";  //mot de passe trop court
                     ...
                     $erreur7 = "";//"Adresse mail déjà utilisée !";
                  }

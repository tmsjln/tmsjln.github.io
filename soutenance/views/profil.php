  ...
  <body>
    <div align="center">
     ...
     if($userinfo['id'] == $_SESSION['id']) {
       ...
       ?>
       <br />
       <button class="retourbouton"><a class="linkprof" style="text-decoration: none; font-style: normal" href="index.php?action=goto_editionprofil">Editer mon profil</a></button>
       <button class="retourbouton"><a class="linkprof" style="text-decoration: none; font-style: normal" href="index.php?action=goto_deconnexion">Se déconnecter</a></button>
       
       <button class="retourbouton"><a class="linkprof" style="text-decoration: none; font-style: normal" href="index.php?action=goto_listesallesoff">Liste des salles </a></button>
       ...
       <div align="center">
         ...
         while ($data = $reqb->fetch()) { ////////// boucle 
           if($data['adminreq']==1){
             ...
             echo  '<font color="cyan">'.$data['mail'] . "</font><br />\n";
             ?>

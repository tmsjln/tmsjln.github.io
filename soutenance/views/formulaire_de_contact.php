...
<br><br>
  ...
  <div class="page__demo">
    <label class="field a-field a-field_a1 page__field">
      <input name="nom" class="field__input a-field__input" placeholder='<?php if(isset($_SESSION['id'])){
      	echo $user['pseudo'];
}else{echo'e.g. max75';}?>' value='<?php if(isset($_SESSION['id'])){
...
echo $user['pseudo'];
    ...
    <label class="field a-field a-field_a2 page__field">
      <input name="mail" class="field__input a-field__input" placeholder='<?php if(isset($_SESSION['id'])){
echo $user['mail'];
}else{echo'e.g. max@gmail.com';}?>' value='<?php if(isset($_SESSION['id'])){
